...
const Register = () => {
  ...
  const passwordRequirements = [
    ...
    { text: 'Contains at least one letter', test: (pwd) => /[a-zA-Z]/.test(pwd) },
    { text: 'Contains at least one number', test: (pwd) => /\d/.test(pwd) },
    { text: 'Contains at least one special character', test: (pwd) => /[!@#$%^&*(),.?":{}|<>]/.test(pwd) }
  ];
